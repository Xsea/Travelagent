"""Aufgabe 4 — Planning (Lösung).

Run:
    python -m Solutions.d_Agenten.aufgabe4_planning.main
...
from Solutions.d_Agenten.tools import (
    book_hotel,
...
from Solutions.d_Agenten.tools_description import (
...
system_prompt = (
    ...
    "\n"
    "Before calling any tool, write out a short numbered plan of the steps "
    "you intend to take and which tool each step needs. After every tool "
    "result, briefly check the plan against what you've learned and adjust "
    "if needed. When all steps are done, give the user a single concise "
    "summary answer."
)
